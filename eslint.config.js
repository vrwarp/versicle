...
export default tseslint.config(
  ...
  // test/vendor-contracts/ holds the relocated contract suites for the upstream
  // y-idb / y-cinder / zustand-middleware-yjs deps. y-cinder's unit + utils
  // suites are ported-from-the-fork code, kept diff-minimal against upstream, so
  // they stay exempt; the y-idb and zustand contract suites ARE linted.
  {
    ignores: [
      'dist',
      'coverage',
