...
4. The main way to run the complete verification test suite is `python verification/run_all.py`.
...
2. Check that the playwright verification suite succeeds. Fix issues and repeat until it is true.
