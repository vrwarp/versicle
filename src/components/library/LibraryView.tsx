...
export const LibraryView: React.FC = () => {
  ...
  const filteredAndSortedBooks = useMemo(() => {
    ...
    // We filter directly on `books` instead of creating an intermediate `searchableBooks` array.
    // This avoids O(N) object/string allocations on every store update (e.g. reading progress changes).
