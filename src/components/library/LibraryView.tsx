...
export const LibraryView: React.FC = () => {
  ...
  // OPTIMIZATION: Defer the search query to prevent blocking the UI thread during typing.
  // This allows the input to update immediately while the expensive filter/sort operation
  // happens in the background or next render tick.
  ...
  const filteredAndSortedBooks = useMemo(() => {
    // Use deferredSearchQuery instead of searchQuery to avoid re-calculating on every keystroke
