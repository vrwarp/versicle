...
export const ChapterCompass: React.FC<ChapterCompassProps> = ({ onPrev, onNext }) => {
  return (
    <div data-testid="chapter-compass" className="absolute bottom-20 left-0 right-0 px-6 md:px-8 pointer-events-none z-40 flex items-end justify-between md:justify-center">
