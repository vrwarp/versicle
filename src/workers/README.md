...
*   **`search.worker.ts`**: The dedicated worker for full-text search. It initializes the `SearchEngine` (a RegExp-based scanner), indexes book content, and processes search queries sent from the main thread.
