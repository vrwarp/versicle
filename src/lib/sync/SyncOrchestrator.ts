...
export class SyncOrchestrator {
    ...
    private async applyManifest(manifest: SyncManifest) {
        const db = await getDB();
        const tx = db.transaction(['static_books', 'user_book_states', 'user_reading_history', 'user_annotations', 'user_lexicon', 'user_reading_list', 'user_tts_position'], 'readwrite');
