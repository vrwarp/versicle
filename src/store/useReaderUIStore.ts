...
/**
 * State interface for the Reader UI store.
 * Manages transient state like current book ID, TOC, and view mode.
 */
...
/**
 * Zustand store for managing the transient UI state of the book reader.
 */
