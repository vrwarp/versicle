...
def test_journey_advanced_import(page: Page):
    ...
    screenshot_step(page, "advanced_import_01_library_view")
    ...
    screenshot_step(page, "advanced_import_02_settings_dialog")
    ...
    screenshot_step(page, "advanced_import_03_closed_settings")
