...
*   **Tools**: `browser-image-compression`, `JSZip`, `lucide-react`, `react-lazy-load-image-component`, `react-window`, `dompurify`, `@google/generative-ai`, `y-cinder`, `y-indexeddb`, `piper-wasm`
