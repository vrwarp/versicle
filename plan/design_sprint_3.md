...
*   **Content:** Playback controls, Queue, Voice selection, Speed, Sanitization toggles, Gesture Mode.
*   **Philosophy:** Users shouldn't leave the player to change the voice or control mode.
